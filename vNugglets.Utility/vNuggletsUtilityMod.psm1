...
$hshModuleMemberParams = @{
	Function = Write-Output Connect-VNVIServer, Copy-VNVIRole, Disconnect-VNVIServer,
		Get-VNNetworkClusterInfo, Get-VNUplinkNicForVM, Get-VNVMByAddress, Get-VNVMByVirtualPortGroup, Get-VNVMEVCInfo, Get-VNVMHostBrokenUplink,
		Get-VNVMHostFirmwareInfo, Get-VNVMHostHBAWWN, Get-VNVMHostLogicalVolumeInfo, Get-VNVMHostNICFirmwareAndDriverInfo, Move-VNTemplateFromVMHost,
